...
activities = {
    ...
    "Drama Club": {
        "description": "Act in plays, improve public speaking, and develop stage presence",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": []
    },
    "Robotics Club": {
        "description": "Build and program robots to solve engineering challenges",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 14,
        "participants": []
    },
    "Math Olympiad": {
        "description": "Solve complex math problems and prepare for competitions",
